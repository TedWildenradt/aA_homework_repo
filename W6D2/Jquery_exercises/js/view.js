...
View.prototype.exercise3 = function () {
  ...
  //your code here!
  const $h1Title = $( '<h1>i love jquery</h1>' )
  this.$el.append($h1Title)
};
...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  $(".square:nth-child(even)").text("Ted");
};
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  $('.square').addClass(window._randomColorString())
  // $('.square').addClass('red')
};
